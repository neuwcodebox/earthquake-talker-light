...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        return cls(
            ...
            state_path=Path(os.getenv("STATE_PATH", ".state/earthquake_talker_state.json")),
            ...
            pews_interval_seconds=_float_env("PEWS_INTERVAL_SECONDS", 0.5),
            overseas_interval_seconds=_float_env("OVERSEAS_INTERVAL_SECONDS", 60.0),
